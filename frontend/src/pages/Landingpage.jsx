    ...
    <>
      ...
      <div className="relative bg-[#004AAD] h-[500px] w-full flex flex-col justify-center items-center p-4">
        <div className="text-center">
          <h1 className="text-white text-5xl font-poppins font-bold mb-4">
            Trading with GoAlgo means
          </h1>
          <div className="flex items-baseline justify-center mb-4">
            <h1 className="text-white text-5xl font-poppins font-bold">
              Trading with
            </h1>
            <h1 className="text-black text-5xl font-poppins font-bold ml-2">
              Precision
            </h1>
          </div>
          <h4 className="text-white mb-4">
            Make your life simple with our fully automated & configurable Algorithms
          </h4>
          <div className='flex flex-col justify-center items-center'>
            <Link to='/sign-in'>
              <button type="button" className="flex items-center text-xl gap-2 px-6 py-3.5 font-medium text-[#004AAD] bg-white border-2 border-[#004AAD] hover:bg-[#004AAD] hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg transition duration-300 ease-in-out hover:shadow-lg">
                Sign Up now
              </button>
            </Link>
          </div>
        ...
        {/* Curve */}
        <div className="relative bg-#004AAD h-[250px] w-full curved-container">
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-around mt-10">
        <div className="flex flex-col items-center relative h-[340px] w-[470px] p-4 mb-8">
          ...
          <div className="flex flex-col justify-center items-center text-center flex-grow">
            <h3 className="text-black font-poppins text-xl">
              Providing insightful analytics to help traders make i~nformed decisions and optimize their trading performance
            </h3>
          </div>
        </div>
        <div className="flex flex-col items-center relative h-[340px] w-[470px] p-4 mb-8">
